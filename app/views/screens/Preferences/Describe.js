...
const Describe = ({navigation}) => {
    ...
    const [smokeHabit,setSmokeHabit]= useState();
    const [drinkingHabit,setDrinkingHabit]= useState();
    const [wantKids,setWantKids]= useState();

    const handleItem = (astro) => {
        setAstrologicalSign(astro);
        // await AsyncStorage.setItem("astrology",astro);

        setBottomSheetShow(false);
    }

    const religionHandleItem = (religion) => {
     ...
     const politicalHandleItem = (political) => {
        setPoliticalViews(political)
        // await AsyncStorage.setItem("political",political);
     ...
     const drinkHandleItem = (drink) => {
        setDrinkingHabit(drink);
        // await AsyncStorage.setItem("drink",drink);

        setDrinkBSShow(false);
    }

     const wantKidsHandleItem = (kids) => {
        setWantKids(kids);
        // await AsyncStorage.setItem("wantKids",kids);
                ...
                <View style={STYLES.createAccountWrap}>
                    ...
                    <View style={{width: 300, padding: 10}}>
                        ...
                        <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10}}> 
                            <TextInput  editable={false} placeholder="Choose one" style={{fontSize: 16, color: COLORS.grey}} value={astrologicalSign}/>
                    ...
                    <View style={{width: 300, padding: 10}}>
                        ...
                        <Text style={STYLES.labelText}>2. What is your Religion?</Text>
                         <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10}}> 
                            <TextInput  editable={false} placeholder="Choose one" style={{fontSize: 16, color: COLORS.grey}} value={religion}/>
                    ...
                    <View style={{width: 300, padding: 10}}>
                        ...
                        <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10}}> 
                            <TextInput  editable={false} placeholder="Choose one" style={{fontSize: 16, color: COLORS.grey}} value={politicalViews} />
                    ...
                    <View style={{width: 300, padding: 10}}> 
                        ...
                        <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10}}> 
                            <TextInput  editable={false} placeholder="Choose one" style={{fontSize: 16, color: COLORS.grey}} value={drinkingHabit}/>
                    ...
                    <View style={{width: 300, padding: 10}}>
                        ...
                        <Text style={STYLES.labelText}>5. How often do you smoke?</Text>
                         <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10}}> 
                            <TextInput  editable={false} placeholder="Choose one" style={{fontSize: 16, color: COLORS.grey}} value={smokeHabit} />
                    ...
                    <View style={{width: 300, padding: 10}}>
                        ...
                        <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10}}> 
                            <TextInput  editable={false} placeholder="Choose one" style={{fontSize: 16, color: COLORS.grey}} value={wantKids}/>
                ...
                <BottomSheet isVisible={bottomSheetShow}>
                    <View style={{backgroundColor: COLORS.white, padding: 20}}>
                        ...
                        </View>
                        {
                            ...
                            (
                                <ListItem key={i} onPress={()=>handleItem(l.sign)} >
                                    <ListItem.Content>
                ...
                <BottomSheet isVisible={religionBSShow}>
                    <View style={{backgroundColor: COLORS.white, padding: 20}}>
                        ...
                        </View>
                        {
                            ...
                            (
                                <ListItem key={k} onPress={()=>religionHandleItem(j.belief)} >
                                    <ListItem.Content>
                ...
                <BottomSheet isVisible={politicalBSShow}>
                    <View style={{backgroundColor: COLORS.white, padding: 20}}>
                        ...
                        </View>
                        {
                            ...
                            (
                                <ListItem key={n} onPress={()=>politicalHandleItem(m.view)} >
                                    <ListItem.Content>
                ...
                <BottomSheet isVisible={drinkBSShow}>
                    <View style={{backgroundColor: COLORS.white, padding: 20}}>
                        ...
                        </View>
                        {
                            ...
                            (
                                <ListItem key={p} onPress={()=>drinkHandleItem(o.habit)} >
                                    <ListItem.Content>
                    ...
                    <View style={{backgroundColor: COLORS.white, padding: 20}}>
                        ...
                        </View>
                        {
                            ...
                            (
                                ...
                                <ListItem key={r} onPress={()=>smokeHandleItem(q.smoke)} >
                                    <ListItem.Content>
                ...
                <BottomSheet isVisible={wantKidsBSShow}>
                    <View style={{backgroundColor: COLORS.white, padding: 20}}>
                        ...
                        </View>
                        {
                            ...
                            (
                                <ListItem key={u} onPress={() =>wantKidsHandleItem(t.want)} >
                                    <ListItem.Content>
